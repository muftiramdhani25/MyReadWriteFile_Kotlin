package net.growdev.myreadwritefile_kotlin
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun saveFile(){
        when{
            ...
            edit_file.text.toString().isEmpty() -> Toast.makeText(this, "Konten harus diisi telebih dahulu", Toast.LENGTH_SHORT).show()
            else -> {
